import { ALL_WORDS, NUMBER_OF_TRIES, letterColors } from './constants';
import { gameElement, popupElement } from './dom';
...
export { printWord, generateRandomWord, getUserWord };
